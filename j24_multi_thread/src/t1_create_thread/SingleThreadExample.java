...
public class SingleThreadExample {
	 ...
	 * main thread 에서 호출되는 method
	 * main thread 에서 호출된 main method 가 종료되면 프로세스도 종료
	 * 
	...
	public static void main(String[] args) {
		...
		// Java 에서 Multi Thread 지원을 위해 제공되는 객체 : Thread
		...
		for (int i = 0; i < 5; i++) {
			...
			// 현재 작업 중인 스레드를 매개 변수로 전달된 millis second 만큼 작업 대기
			try {
