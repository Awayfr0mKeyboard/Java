...
public class ArrayListExample {
	...
	public static void main(String[] args) {
		...
		// list 에 항목 추가
		// array.add(100);		// generic 으로 지정한 String type 이 아닐 경우 컴파일러가 체크
		array.add("java");
		array.add("JDBC");
		int size = array.size();
		...
		// list 0번 째 인덱스에 저장된 항목의 값
		String str = array.get(0);
		System.out.println(str);
		// ArrayList array 5번 째 인덱스 항목의 값을 읽고 있음
		...
		// array list 의 2번 째 인덱스에 문자열 항목 추가
		...
		// remove - 0번 째 인덱스부터 검색하여 처음 검색된 일치하는 항목 list 에서 제거
		...
		// list 에 저장된 항목들 중에 매개변수로 전달받은 객체와 동등한 객체가 존재하면 true, 없으면 false
