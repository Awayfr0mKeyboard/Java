...
public class TreeSetExample {
	...
	public static void main(String[] args) {
		...
		// [75, 80, 87, 90]
		score = treeSet.first();
		System.out.println("treeSet 첫 번째 값 : " + score);		// 최소 값
		
		score = treeSet.last();
		System.out.println("treeSet 마지막 값 : " + score);		// 최대 값
		...
		System.out.println("첫 번째 값을 꺼내오고 set에서는 삭제 : " + score);
		...
		// [75, 80, 87, 90]
		// 범위 검색 - headSet() - 매개 변수로 전달된 값보다 이전의 항목으로 새로운 set 생성
		...
		// 81 이후 88 이전 특정 위치의 항목으로 새로운 Set 생성
