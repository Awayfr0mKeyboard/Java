...
public class FileExample {
	...
	public static void main(String[] args) {
		...
		System.out.println("path : " + file.getPath());
		System.out.println("=========================================");
		// 매개변수가 2개 첫 번째 매개변수가 공백이면 디스크 드라이브의 최상위 경로
		// new File(상위 디렉토리, 하위 디렉토리 또는 파일)
		...
		// 삭제 할려는 파일 정보가 디렉토리일 경우
		// 디렉토리 내부에 '하나라도 파일 정보가 존재'하면 삭제 실패
