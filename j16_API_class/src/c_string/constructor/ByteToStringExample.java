...
public class ByteToStringExample {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		// bytes 배열의 6번 째 인덱스부터 4개 만큼 UTF-8언어 셋으로 디코딩된 문자열 생성
		...
		// String class 에 저장된 문자열을 char 배열로 반환
		...
		// 0번 째 인덱스부터 2개 만큼의 항목으로 문자열 생성
		//  0     1    2    3     4
		// '안', '녕', '하', '세', '요'
		// 언어셋을 따로 지정하지 않으면 java 는 기본적으로 UTF-8
		...
		// UTF-8 문자셋은 한 개의 문자를 3byte 로 표현
		byte[] bytes1 = str.getBytes();
		System.out.println(bytes1.length);
		
		// String class 에 저장된 문자열을 EUC-KR 언어셋으로 인코딩해서 반환
