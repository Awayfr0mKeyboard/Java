 ...
 * 연산에 필요한 상수와 기능을 추가형 묶어놓은 class
...
public class WrapperClassExample {
	...
	public static void main(String[] args) {
		...
		// int type 의 정수값을 포장한 Integer 객체
		Integer obj1 = null;
		...
		// 변환 타입이 Wrapper class
		Long l = Long.valueOf("1000000");
		System.out.println(l);
		
		// 문자열에 저장된 데이터를 기본 타입으로 변환
		...
		// Wrapper class 의 타입에 맞는 값을 비교하는 method
		...
		// new 연산자로 생성된 Wrapper class 에 저장된 실제 값을 비교
		System.out.println(i3.equals(i4));
		
		test(Integer.valueOf("100"));
		test(Float.valueOf(3.14F));
		
		// Number 를 상속받고 있지않은 객체는 매개변수에 대입 불가
