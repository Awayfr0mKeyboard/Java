...
// class block 외부에 작성할 수 있는 code는 다른 class 정의
/*
 * package 명시
 * import 명시
 * 만 가능하다.
...
public class Operators00ArithmeticTest {
	// 메인 method가 포함되어 있는 문서에 focus가 가 있을 경우에는 ctrl + F11로 실행 가능
	public static void main(String[] args) {
		...
		/*
		 	+ - / * %
		 	TODO num1과 num2의 나머지 산술 연산 결과를 result 변수에 저장하여 출력
