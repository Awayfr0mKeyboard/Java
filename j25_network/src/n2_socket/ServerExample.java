...
public class ServerExample {
	...
	public static void main(String[] args) {
		...
		// 할당 받아 연결 요쳥이 들어온 client Socket 을 생성하는 class
		...
		try {
			...
			while(true) {
				...
				System.out.println("클라이언트 연결 머기 중...");
				// accept(); : client 에서 연결 요청이 들어올 때까지 대기하다가
				// 연결 요청이 들어오면 요청이 들어온 클라이언트 정보를 Socket 객체에 저장하여 반환
