...
public class LottoExample {
	...
	public static void main(String[] args) {
		...
		// 1 ~ 45까지의 난수 6개를 추출해서 행운 번호 저장
		
		// 난수 추출
		// Math : 수학과 관련된 계산 기능을 저장하는 객체
		// Math.random(); 호출되는 시점에 랜덤한 난수를 반환하는 함수
		// 0.0 ~ 0.9999999999999999...; 까지의 실수
		// 0이상 1미만의 실수를 전달
		// 0.999999999999999; * 45 == 44.9999999...
		// 0.0 * 45 == 0
		...
		int count = 0;    // 외부 for문의 반복 횟수를 저장할 변수
		...
		*/
		...
		// 앞의 값이 크면 뒤에 있는 값과 자리를 변경하여 오름차순으로 정렬
		for (int i = 0; i < lotto.length; i++) {
