...
public class ArrayRefExample {
	...
	public static void main(String[] args) {
		// 배열 선언과 동시에 초기화    new int[]{70, 60, 50, 40, 60, 60}; new int[] 생략
		int[] scores = {70, 60, 50, 40, 60, 60};
		//  0    1    2    3    4    5
		// [70] [60] [50] [40] [60] [60]
		// 배열의 시작 인덱스 번호 : 0
		// 할당된 배열의 마지막 인덱스 번호 : 5 (배열의 항목 크기 - 1)
		System.out.println(scores.length);
		// scores 배열의 0번 째 인덱스를 가진 항목의 값을 80으로 변경
		scores[0] = 80;
		// [80] [60] [50] [40] [60] [60]
		...
		double[] doubles = new double[3];    // 8byte의 실수를 3개를 저장하는 배열 생성
		doubles[1] = 3.141592;    // [0.0] [3.141592] [0.0]
		...
		// int[] arrays[];    // 2차원 배열의 선언
		// int[][] arrays; or int arrays[][];
		...
		// 이차원 배열의 선언과 동시에 초기화
		int[][] scoresArray = {    // int[][] socresArray = new int[][]{};
				// scoresArray.length : 2
