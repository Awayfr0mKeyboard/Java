...
public class ArrayTest<E> {
	...
	public void add(E e) {
		...
		if (length < capacity) {
			// 저장 공간이 있을 경우
			// E[] array 배열에 0번 째 인덱스부터 검색하여 빈자리(null)에 저장
			...
			// 저장 공간이 없을 경우
			// 새로운 데이터를 저장할 항목을 가지고 있는 배열을 생성해서 마지막 인덱스에 저장
	...
	/**
	 * E[] array 배열 안에서 동일한 항목을 검색하여 삭제
	 * 동일한 항목이 존재하여 배열에서 삭제될 경우
	...
	// ArrayTest 가 저장하는 E[] array 배열 정보를 문자열로 반환
	@Override
