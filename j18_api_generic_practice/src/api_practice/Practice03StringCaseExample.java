...
public class Practice03StringCaseExample {
	...
	public static void main(String[] args) {
		...
		// 특정 문자열에 매개변수로 전달된 지정 문자열이 포함되어 있는지 확인하는 메소드
		...
		System.out.println("숫자 문자 : " + isCheckDigit);
		
		System.out.println("=============================");
		// 문자열.indexOf("확인할 문자열")
		// "확인할 문자열" 이 시작되는 인덱스 번호 반환
		...
		System.out.println("lower case 영어 문자 : " + isCheckEng);
