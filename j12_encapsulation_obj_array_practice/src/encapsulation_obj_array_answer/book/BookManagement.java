...
public class BookManagement {
	...
	public void  registerBook() {
		...
		*/
		...
		for (int i = 0; i < books.length; i++) {
			...
			if (books[i] == null) {
				// 도서 관리 번호 등록
				// 도서가 저장된 index 번호를 이용하여 도서관리번호 등록
				book.setNum(i + 1);
	...
	public Book findBook(int num) {
		...
		// 반복문이 종료될 때까지 일치하는 책을 찾지 못하면
		// 도서관리번호가 일치하는 책이 존재하지 않음.
		return null;
	}
